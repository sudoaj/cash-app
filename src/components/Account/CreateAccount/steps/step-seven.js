...
export class StepSeven extends React.Component {
        ...
        return(
            <Fragment>
                <Container>
                    <FollowHeader>
                        <LeftHeader>
                            <HeaderTxt>Recommended Members To Follow</HeaderTxt>
                        </LeftHeader>
                        <RightHeader>
                            <SearchBox>
                    ...
                    <CollegesContainer>
                        {colleges.map((college, index) => (
                            <EachColleges key={index} index={index+1} onClick={() => this.selectMember(college.id)}>
                                <CollegeWrap>
                                    <CollegeLogo image={college.logo}>
                                        <Marked active={selectedMembers.includes(college.id)}>
