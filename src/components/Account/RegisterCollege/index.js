    ...
    <TabsContainer style={{ display: props.visibility }}>
        <Formik
            ...
            validationSchema={Yup.object().shape({
                ...
                location: Yup.string().required('college location is required'),
                phone: Yup.string()
...
const TabTwo = props => (
    <TabsContainer style={{ display: props.visibility }}>
        <TabHeading>Upload College Members</TabHeading>
        <TabDesc>
            Please upload your college member details. Please download template to
    ...
    <TabsContainer style={{ display: props.visibility }}>
        ...
        <SetActivityWrapper>
            ...
            <EachActivity onClick={() => props.chooseActivity('hide')}>
                ...
                <ActivityText>Hide College Activity</ActivityText>
            </EachActivity>
            <EachActivity onClick={() => props.chooseActivity('show')}>
                ...
                <ActivityText>Get college live on platform</ActivityText>
            </EachActivity>
        </SetActivityWrapper>
        <TabButtonContainer>
            <TabPrevWrapper>
    ...
    handleSubmit = values => {
        ...
        switch (tab) {
            ...
            case 3:
                ...
                break
            default:
                this.props.history.push('/college/dashboard')
                        ...
                        <BackDropWrapper className="fadeIn animated">
                            ...
                            <TabNavRight className="fadeInUp animated">
                                ...
                                <TabTitleContainer>
                                    ...
                                    <EachTabDesc>
                                        Tell us about your college and build your online presence
                                    </EachTabDesc>
                                </TabTitleContainer>
                            </TabNavRight>
                        </BackDropWrapper>
